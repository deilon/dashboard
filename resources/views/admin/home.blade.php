...
<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <div class="card bg-transparent shadow-none border-0 my-4">
      <div class="card-body row p-0 pb-3">
         <div class="col-12 col-md-4 card-separator">
            <h3>Welcome back, {{ ucwords( Auth::user()->firstname.' '.Auth::user()->lastname ) }} 👋🏻 </h3>
            <div class="col-12 col-lg-7 ">
               <p>Overview and Real-Time Insights.</p>
            </div>
         </div>
         <div class="col-12 col-md-4 ps-md-3 ps-lg-5 pt-3 pt-md-0 card-separator">
            <div class="d-flex justify-content-between align-items-center" style="position: relative;">
               <div>
                  <div>
                     <h5 class="mb-2">Sales Revenue</h5>
                     <p class="mb-4">Monthly Report</p>
                  </div>
                  <div class="time-spending-chart">
                     <h3 class="mb-2 text-primary">₱{{ $monthly_sales_total }}</h3>
                     <span class="badge bg-label-success">+₱{{ $daily_sales_total }} added today</span>
                  </div>
               </div>
            </div>
         </div>
         <div class="col-12 col-md-4 ps-md-3 ps-lg-5 pt-3 pt-md-0">
            <div class="d-flex justify-content-between align-items-center" style="position: relative;">
               <div>
                  ...
                  <div class="time-spending-chart">
                     <h3 class="mb-2 text-warning">₱{{ $monthly_pending_subscriptions_amount }}</h3>
                  </div>
               </div>
            </div>
         </div>
